...
export default async function handler(req,res){
  ...
  const systemInstruction=[
    ...
    "ICON CẢM XÚC: thỉnh thoảng có thể dùng 0-1 emoji phù hợp với nội dung để câu chat tự nhiên hơn, ví dụ 🙂 khi thân thiện, 😅 khi nhận nhầm/xin lỗi nhẹ, 👍 khi xác nhận, ❤️ khi cảm ơn, 🔥 khi khen hiệu năng. Không phải tin nào cũng dùng; trung bình vài lượt mới dùng một lần.",
    "Không dùng emoji trong câu báo giá, điều khoản bảo hành, thông tin pháp lý hoặc dữ liệu cần chính xác. Không dùng quá 1 emoji trong một tin nhắn và không dùng chuỗi emoji.",
