    ...
    try{
      ...
      if(r.ok){
        ...
        if(text){
          ...
          return res.status(200).json({ok:true,text:visible,model,needsHuman:false,knowledgeGap:!!parsed.missing,understoodIntent:questionUnderstanding.intent,understoodFocus:questionUnderstanding.focus});
        }
      }
