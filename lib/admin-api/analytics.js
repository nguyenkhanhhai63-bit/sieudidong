...
export default async function handler(req,res){
  ...
  try{
    ...
    const yesterday=d365[d365.length-2];
    ...
    const [visitorsYesterday,warrantyPhonesYesterday,visitorsMonth,visitorsYear,warrantyPhonesMonth,warrantyPhonesYear]=await Promise.all([
      visitorsFor([yesterday]),warrantyPhonesFor([yesterday]),visitorsFor(monthDates),visitorsFor(yearDates),warrantyPhonesFor(monthDates),warrantyPhonesFor(yearDates)
    ]);
    ...
    const periods={
      ...
      yesterday:makePeriod([yesterday],visitorsYesterday,warrantyPhonesYesterday),
