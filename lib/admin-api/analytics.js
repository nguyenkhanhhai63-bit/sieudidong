...
export default async function handler(req,res){
  ...
  try{
    ...
    const [productRanks,searchRanks,compareProductRanks,comparePairRanks,devicePeriod,aiQuestionHistory,trafficSources]=await Promise.all([
