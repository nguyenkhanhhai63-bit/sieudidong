...
export default async function handler(req,res){
  ...
  try{
    ...
    const [vis7,vis30,visMonth,visYear,phonesToday,phones7,phones30,phonesMonth,phonesYear,totalVisitors,totalPageviews,devices,topProducts,topSearches,topCompareProducts,topComparePairs,modelsV2,modelsOld,osV2,osOld,filters,warrantyPhonesAll]=await Promise.all([
