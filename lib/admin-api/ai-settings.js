...
async function writeChatHash(settings){
  const pairs=[
    ...
    "chatWelcomeMessages",settings.chatWelcomeMessages,
    "chatWelcomePrompt",settings.chatWelcomePrompt,
  ...
  const fields=["chatInstructions","chatWelcomeMessage","chatWelcomeMessages","chatWelcomePrompt","chatStoreFacts","chatHandoffRules","chatSuggestions"];
  ...
  if(req.method==="POST"){
    try{
      ...
      const fields=[
        ...
        "chatInstructions","chatWelcomeMessage","chatWelcomeMessages","chatWelcomePrompt","chatStoreFacts","chatHandoffRules","chatSuggestions"
      ];
