...
const DEFAULTS={
  ...
  policyItems:[
    {label:"Chính sách bảo hành",url:"/tra-cuu-bao-hanh.html"},
    {label:"Tra cứu bảo hành",url:"/tra-cuu-bao-hanh.html"},
  ...
  utilities:[
    {icon:"search",label:"Tra cứu",sub:"Bảo hành",url:"/tra-cuu-bao-hanh.html"},
  ...
  legalRepresentative:"",
  moitEnabled:false,
  moitLabel:"Đã thông báo Bộ Công Thương",
  moitUrl:"",
  moitBadgeImage:"",
  accent:"#ff5a00",
  background:"#111b25",
...
function normalize(body={}){
  return {
    ...
    legalTitle:text(body.legalTitle||DEFAULTS.legalTitle,100),legalEntityName:text(body.legalEntityName,160),taxId:text(body.taxId,60),businessRegistration:text(body.businessRegistration,120),legalAddress:text(body.legalAddress,240),legalPhone:text(body.legalPhone,60),legalEmail:text(body.legalEmail,120),legalRepresentative:text(body.legalRepresentative,140),moitEnabled:body.moitEnabled===true||body.moitEnabled==='true',moitLabel:text(body.moitLabel||DEFAULTS.moitLabel,120),moitUrl:url(body.moitUrl),moitBadgeImage:url(body.moitBadgeImage),
