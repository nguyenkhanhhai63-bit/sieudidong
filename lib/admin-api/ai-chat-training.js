...
export default async function handler(req,res){
  ...
  if(req.method==="POST"){
    try{
      ...
      const fields=["chatInstructions","chatWelcomeMessage","chatWelcomeMessages","chatWelcomePrompt","chatStoreFacts","chatHandoffRules","chatSuggestions","chatMessageStyle","chatStaffNames","chatTypingEnabled","chatInitialDelayMin","chatInitialDelayMax","chatBubbleDelayMin","chatBubbleDelayMax","chatInterMessageMin","chatInterMessageMax"];
