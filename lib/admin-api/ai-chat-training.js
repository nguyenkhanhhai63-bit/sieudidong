...
export default async function handler(req,res){
  ...
  if(req.method==="POST"){
    try{
      ...
      const fields=["chatInstructions","chatWelcomeMessage","chatStoreFacts","chatHandoffRules","chatSuggestions","chatMessageStyle","chatTypingEnabled","chatInitialDelayMin","chatInitialDelayMax","chatBubbleDelayMin","chatBubbleDelayMax","chatInterMessageMin","chatInterMessageMax"];
