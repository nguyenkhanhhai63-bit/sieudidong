...
function aiChatSetHumanHandoff(show,reason=""){
  ...
  if(note && show){
    note.textContent=reason || "Nội dung này cần nhân viên hỗ trợ trực tiếp.";
  }
}
...
function aiChatNeedsHuman(data={}){
  // V401: backend quyết định rõ khi nào cần chuyển nhân viên.
  // Không suy đoán từ các từ như “địa chỉ”, “liên hệ”, “xác nhận” vì AI có thể
